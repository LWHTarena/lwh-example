...
# 二、Seata 详细工作流程示例
![在这里插入图片描述](./img/architecture.png)
...
![在这里插入图片描述](./img/image-20210302094940682.png)
...
![在这里插入图片描述](./img/image-20210302102427688.png)
...
## 2. 新建工程
![在这里插入图片描述](./img/image-20210302111457693.png)
