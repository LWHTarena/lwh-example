...
public class SearchFiles {
    ...
    public static void main(String[] args) throws Exception {
        String usage = "Usage:java com.lwhtarena.lucene.example4.SearchFiles [-index dir] [-field f] [-repeat n] [-queries file] [-query string] [-raw] [-paging hitsPerPage] See http://lucene.apache.org/core/4_1_0/demo/ for details.";
