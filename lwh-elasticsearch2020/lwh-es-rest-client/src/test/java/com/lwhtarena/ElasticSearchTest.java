...
//
//        /**
//         * Java高级别REST客户端（The Java High Level REST Client）以后简称高级客户端，内部仍然是基
//         * 于低级客户端。它提供了更多的API，接受请求对象作为参数并返回响应对象，由客户端自己处理编码和解码。
//         *
//         * 每个API都可以同步或异步调用。 同步方法返回一个响应对象，而异步方法的名称以async后缀结尾，需要一
//         * 个监听器参数，一旦收到响应或错误，就会被通知（由低级客户端管理的线程池）。
//         *
...
//
//        /**创建每个索引都都可以有与之关联的特定设置**/
//        request.settings(Settings.builder()
//                .put("index.number_of_shareds",3)
