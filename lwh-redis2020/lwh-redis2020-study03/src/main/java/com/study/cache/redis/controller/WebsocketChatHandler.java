...
public class WebsocketChatHandler extends TextWebSocketHandler {
    ...
    public void handleTextMessage(WebSocketSession session, TextMessage message) throws IOException {
        ...
        RedisClient redisClient = RedisClient.create("redis://192.168.1.8:16379"); // 每一次都创建
    ...
    public void init() {
        new Thread(() -> {
//            RedisClient redisClient = RedisClient.create("redis://192.168.1.8:16379");
